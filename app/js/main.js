...
var Demos = React.createClass({
  ...
  export: function () {
      ...
      var svg = document.querySelector('.rd3-chart').innerHTML;
      ...
      doc.addImage(imgData, 'PNG', 40, 40, 1000, 500);
      doc.save('test.pdf');
  ...
  render: function() {
    ...
    return (
      <div className="container">
        ...
        <button onClick={this.export}> Relatório </button>
        <div className="row">
